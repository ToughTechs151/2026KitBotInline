...
public class CANFuelSubsystem extends SubsystemBase {
  ...
  private TunableNumber proportionalGain = new TunableNumber("Launcher Kp", LAUNCHER_KP_VOLTS_PER_RPM);
  ...
  private TunableNumber accelerationGain = new TunableNumber("Launcher Ka", LAUNCHER_KA_VOLTS_PER_RPM2);
  ...
  private SimpleMotorFeedforward feedforward = new SimpleMotorFeedforward(staticGain.get(), velocityGain.get(),
      accelerationGain.get());
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("LauncherVoltage", launcherRoller.getAppliedOutput()
        * launcherRoller.getBusVoltage());
    SmartDashboard.putNumber("IntakeVoltage", intakeRoller.getAppliedOutput()
        * intakeRoller.getBusVoltage());
